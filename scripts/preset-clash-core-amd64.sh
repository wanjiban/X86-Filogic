...
CLASH_META_URL=$( curl -sL https://api.github.com/repos/MetaCubeX/Clash.Meta/releases/tags/Prerelease-Alpha | grep /mihomo-linux-amd64-compatible-alpha | grep '\.gz"' | awk -F '"' '{print $4}' | head -n 1)
